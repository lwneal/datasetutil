...
def save_set(data_dir, fold, x, y, suffix='png'):
    examples = []
...
def main(data_dir):
    ...
    train = save_set(data_dir, 'train', train_x, train_y)
    test = save_set(data_dir, 'test', test_x, test_y)
    val = save_set(data_dir, 'val', val_x, val_y)
